...
| -------------------------------------------------- | -------------------------------------------------------- |
| [Auth](/docs/backend/modules/auth)                 | Authentication and authorization                         |
| [Cart](/docs/backend/modules/cart)                 | Shopping carts and cart items                            |
| [Catalog](/docs/backend/modules/catalog)           | Products, variants, options, images, categories          |
| [Contact](/docs/backend/modules/contact)           | Storefront contact-form messages and admin inbox         |
| [Content](/docs/backend/modules/content)           | CMS pages                                                |
| [Core](/docs/backend/modules/core)                 | Shared contracts, gateways, DTOs, countries, idempotency |
| [Inventory](/docs/backend/modules/inventory)       | Product stock levels                                     |
| [Media](/docs/backend/modules/media)               | Media uploads                                            |
| [Menu](/docs/backend/modules/menu)                 | Navigation menus and nested links                        |
| [Notification](/docs/backend/modules/notification) | Email notifications (e.g. admins on contact submissions) |
| [Order](/docs/backend/modules/order)               | Orders, order items, order addresses                     |
| [Payment](/docs/backend/modules/payment)           | Payments                                                 |
| [Setting](/docs/backend/modules/setting)           | System settings                                          |
| [Shipping](/docs/backend/shipping)                 | Shipping methods, zones, rates, shipments                |
| [User](/docs/backend/modules/user)                 | Customers/users                                          |

See [Backend / Modules](/docs/backend/modules/auth) for the per-module
...
- **Events** — the primary coupling point. A module publishes domain events
  ...
  listeners. See [Events](/docs/architecture/events).
